...
pub const MASK_SHADER_HANDLE: Handle<Shader> = uuid_handle!("4c41a7eb-b802-4e76-97f1-3327d80743dd");

pub const FLOOD_SHADER_HANDLE: Handle<Shader> =
    uuid_handle!("a06a9919-18e3-4e91-a312-a1463bb6d719");

pub const COMPOSE_SHADER_HANDLE: Handle<Shader> =
    uuid_handle!("6fe0f3ef-e31f-40e7-a20a-ed002ac4bb3f");
pub const HULL_SHADER_HANDLE: Handle<Shader> = uuid_handle!("6b6c1df4-e857-4f9f-a4a3-4ca5f0bc4df4");

pub const VIEW_HELPERS_SHADER_HANDLE: Handle<Shader> =
